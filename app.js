...
app.get('/Laptop1', (req, res) => {
  res.send('Stunning desktop-grade power in a sleek, portable design keeps you playing your best wherever gaming takes you. Take on the most demanding AAA game titles with NVIDIA® graphics and an Intel® Core™ processor[1]. Immerse yourself in smooth gameplay on a narrow-bezel display with fast refresh rates.<br/>Desktop-grade performance<br/>Get the power of a desktop in your laptop. With an Intel® Core™ processor[1], NVIDIA® graphics, and accelerated storage, nothing holds you back.<br/>Fast, fluid gameplay<br/>Crisp gameplay is crucial if you want to play at your best. With a high resolution and refresh rate, on-screen visuals are swift and smooth, while a narrow bezel display delivers edge-to-edge immersion.<br/>Designed for power<br/>The OMEN 17 Laptop sleek, modern design is engineered to produce desktop-grade power. With an advanced thermal cooling solution and single-panel access to internals for easy upgradability, nothing stops you from playing at your best.')
})
app.listen(port, () => {
